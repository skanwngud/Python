...
max1=MaxPooling2D((2,2))(cnn1)
drop1=Dropout(0.2)(max1)
cnn1=Conv2D(300, (2,2), padding='same')(drop1)
max1=MaxPooling2D((2,2))(cnn1)
drop1=Dropout(0.2)(max1)
flat1=Flatten()(drop1)
...
cp=ModelCheckpoint(filepath='./skanwngud/Study/modelCheckpoint/k46_1_fashion_{epoch:02d}-{val_loss:.4f}.hdf5',
                    monitor='val_loss', save_best_only=True, mode='auto')
early=EarlyStopping(monitor='val_loss', patience=5, mode='auto')
model.compile(loss='categorical_crossentropy', optimizer='adam', metrics='acc')
model.fit(x_train, y_train, epochs=20, batch_size=64, validation_data=(x_val, y_val), callbacks=[early, cp])
...
# results
# loss :  [0.2879314124584198, 0.9097999930381775]
# y_pred :
#  [9 2 1 1 6]
# y_test :
#  [9 2 1 1 6]