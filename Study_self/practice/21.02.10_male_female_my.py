...
model=load_model(
    'c:/data/modelcheckpoint/keras67_my_0.8156_0.4196.hdf5'
)
...
# results
# 1 번째 사진이 남자일 확률 :  58.71 % 입니다.
# 1 번째 사진은 남자입니다.
# 2 번째 사진이 남자일 확률 :  21.65 % 입니다.
# 2 번째 사진은 여자입니다.
# 3 번째 사진이 남자일 확률 :  59.12 % 입니다.
# 3 번째 사진은 남자입니다.
# 4 번째 사진이 남자일 확률 :  58.57 % 입니다.
# 4 번째 사진은 남자입니다.
# 5 번째 사진이 남자일 확률 :  32.78 % 입니다.
# 5 번째 사진은 여자입니다.