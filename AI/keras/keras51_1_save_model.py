...
model.save('../data/h5/k51_1_model1.h5') # model 만 저장

modelpath='../data/h5/k45_mnist_{epoch:02d}-{val_loss:.4f}.hdf5'
...
model.save('../data/h5/k51_1_model2.h5') # compile, fitting 값(가중치)도 저장
