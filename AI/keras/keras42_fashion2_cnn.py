...
model.fit(x_train, y_train, epochs=20, batch_size=64, validation_data=(x_val, y_val), callbacks=early)
...
# results - Conv2D 3 layers
# loss :  [0.29360324144363403, 0.9079999923706055]
# y_pred :
#  [9 2 1 1 6]
# y_test :
#  [9 2 1 1 6]